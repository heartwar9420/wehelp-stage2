...
**網址**： [測試網址](https://taipeidaytrip.duckdns.org)
...
| **交易失敗** | `4242-4242-4242-4241` | `11/11` (未來日期) | TapPay SDK 偵測卡號格式錯誤，跳出「刷卡失敗」提示視窗，阻止無效請求發送 |
...
經由 WeHelp 的紮實訓練，在這個專案中，我最大的收穫是**「親手打造資料流的每一個環節」**。
